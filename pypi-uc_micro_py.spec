...
Source0  : https://files.pythonhosted.org/packages/91/7a/146a99696aee0609e3712f2b44c6274566bc368dfe8375191278045186b8/uc-micro-py-1.0.3.tar.gz
...
%prep
%setup -q -n uc-micro-py-1.0.3
cd %{_builddir}/uc-micro-py-1.0.3
pushd ..
cp -a uc-micro-py-1.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707669595
